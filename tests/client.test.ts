...
import type { BrowserResult } from '#/parsers/client/browser';
import type { FeedReaderResult } from '#/parsers/client/feed-readers';
import type { LibraryResult } from '#/parsers/client/libraries';
import type { MediaPlayerResult } from '#/parsers/client/media-players';
import type { MobileAppResult } from '#/parsers/client/mobile-apps';
import type { PersonalInformationManagerResult } from '#/parsers/client/personal-information-managers';
